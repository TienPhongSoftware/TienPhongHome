...
function OurQuality() {
  return (
    <section className="py-[96px] bg-[#f8f9fb]">
      <div
...
mx-auto lg:max-w-maxPartner sm:max-w-maxPartnerSM"
      >
        ...
        <div
          className="lg:text-[1.1vw] sm:text-[8.5vw] 
        ...
        >
          ...
          >
            ...
            applications that advance your business in the digital age. We put
            the quality of delivery at the heart of our culture, forming our
          ...
          <ul className="my-[48px] list-none">
            ...
            md:bg-[2] md:pl-[8.5vw]
            sm:bg-[2.9946524064vw] sm:pl-[12vw]
            bg-[url(/images/icons/list-icon.svg)]
